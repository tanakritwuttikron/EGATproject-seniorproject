<?php 
include 'db.php';
include 'header/header_adminpage.php';
...
<div class="container" algin="top">
  <div class="row">
   ...
   <div class="text1">ข้อมูลบุคคลากรทางการแพทย์
      <a href="edit_detail_admin.php?id=<?php echo $result["id"];?>"><button class="btn btn-default" style="float:right">แก้ไขข้อมูลส่วนตัว</button></a></div></legend>
   <div style="float:right; font-size: 15px;">วันที่แก้ไขล่าสุด : <?php echo $result["today_date"];?> &nbsp; <?php echo $result["today_time"];?></div>

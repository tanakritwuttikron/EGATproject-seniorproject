...
<label class="radio-inline col-md-12">
    <legend><div class="texttitle">ตรวจสอบข้อมูลแพทย์</div></legend>
    <?php
...
<?php
   ...
   $sql = "SELECT * FROM member tm,worktable tw WHERE tm.id = tw.id and (tm.first_name LIKE '%".$strKeyword."%' and tm.department LIKE '%".$strKeyword2."%' and tm.department LIKE '%".$strKeyword3."%') and tm.status_login= 'User'";
...
<div class="row">
    ...
    <div class="col-md-4">
      ...
      <div>&nbsp;</div>
      <div><div class="text1">ประเภท : </div></div>
     </div>
   <div class="col-md-5">
